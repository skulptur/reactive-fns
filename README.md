...
This library is based on the brilliant [Callbag spec](https://github.com/callbag/callbag) by André Staltz, which allows creating both pullable and listenable sources from simple functions. That makes it extremely lightweight and flexible and that's why it shines when used as a primitive for libraries or apps!
